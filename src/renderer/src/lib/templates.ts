...
export const TEMPLATES: CommandTemplate[] = [
...

  {
    ...
    category: 'Exploitation',
    phase: 'exploitation',
    description: 'Searches the local Exploit-DB copy for public exploits matching a service and version string.',
    when_to_use: 'Use this immediately after identifying a service version with nmap. Searchsploit will show you all known public exploits — both remote and local — letting you assess exploitability before choosing your next step.',
  ...
  },
  {
    ...
    when_to_use: 'Use this after identifying a matching exploit with searchsploit. Copying gives you a local file you can modify, compile, and adapt without affecting the original.',
